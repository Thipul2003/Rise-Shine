...
public class ProductTableModel extends javax.swing.JPanel {
    ...
    private void getTableSelection(MouseEvent evt) {
        if (evt.getButton() == 1 && evt.getClickCount() == 1) {
            ...
            product.getProduct_id().setText(String.valueOf(jTable2.getValueAt(row, 0)));
            product.getProductName().setEditable(false);
            product.getAddBrand().setEnabled(false);
    ...
    private void initComponents() {
        ...
        productsSearch = new javax.swing.JTextField();
        ...
        productsSearch.setBackground(new java.awt.Color(240, 240, 240));
        productsSearch.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        productsSearch.setForeground(new java.awt.Color(153, 153, 153));
        productsSearch.setText("Search products");
        productsSearch.setMargin(new java.awt.Insets(2, 20, 2, 2));
        productsSearch.setPreferredSize(new java.awt.Dimension(122, 50));
        productsSearch.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                productsSearchFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                productsSearchFocusLost(evt);
            }
        });
        productsSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                productsSearchKeyPressed(evt);
            }
        });
        viewSupplierPanel.add(productsSearch, java.awt.BorderLayout.PAGE_START);
    ...
    private void productsSearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_productsSearchFocusGained
        productsSearch.setText("");
    }//GEN-LAST:event_productsSearchFocusGained

    private void productsSearchFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_productsSearchFocusLost
        productsSearch.setText("Search products");
    }//GEN-LAST:event_productsSearchFocusLost

    private void productsSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productsSearchKeyPressed
        loadProducts();
    }//GEN-LAST:event_productsSearchKeyPressed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTable jTable2;
    private javax.swing.JTextField productsSearch;
