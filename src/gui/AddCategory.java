...
public class AddCategory extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Category_name.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        Category_name.setMargin(new java.awt.Insets(2, 15, 2, 15));
        jPanel1.add(Category_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 280, 43));
        ...
        addBtn.setBackground(new java.awt.Color(153, 220, 79));
